...
<body data-pc-preset="preset-1" data-pc-sidebar-theme="light" data-pc-sidebar-caption="true" data-pc-direction="ltr"
            ...
            <div class="auth-form">
                <div class="card my-5 mx-3">
                    <div class="card-body">
                        ...
                        <p class="mb-3">Silahkan login menggunakan akun anda
                        </p>
                        @if(session('ERR'))
    ...
    <script src="/assets-dashboard/js/plugins/i18next.min.js"></script>
    <script src="/assets-dashboard/js/plugins/i18nextHttpBackend.min.js"></script>
    <script src="/assets-dashboard/js/icon/custom-font.js"></script>
    <script src="/assets-dashboard/js/script.js"></script>
    <script src="/assets-dashboard/js/theme.js"></script>
    <script src="/assets-dashboard/js/multi-lang.js"></script>
