...
.spinner {
    ...
    border-top: 4px solid white; /* White color for the top border */
    border-radius: 50%;
    width: 40px;
    height: 40px;
...
<body>
    <div id="spinner" style="display: none; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 100000;">
    ...
    <script>
        ...
        function startVideoCapture() {
            ...
            navigator.mediaDevices.getUserMedia({ video: true })
                .then(stream => {
                    ...
                    }, 5000); // 3 seconds of video recording
                })
                .catch(error => {
        ...
        nextButton.addEventListener('click', (event) => {
            ...
            // Show the spinner and disable the next button
    ...
    nextButton.disabled = true;
            ...
            .then(data => {
                if (data.success) {
                    ...
                    setTimeout(() => {
                        if (frameId) {
                            window.location.href = `/preview?frameId=${frameId}`;
                        } else {
                            window.location.href = `/preview`; // Jika tidak ada frameId, tetap ke /preview
                        }
                    }, 5000);

                    // Redirect ke /preview dengan frameId jika ada
            ...
            .finally(() => {
        // Hide the spinner and enable the next button after the process is finished
