...
const claimButton = document.querySelector('.voucher-claim-btn');
const voucherInput = document.querySelector('.voucher-input');
const voucherPage = document.querySelector('#voucherPage');
...
claimButton.addEventListener("click", function () {
    ...
    if (voucherCode == "mudamudi") {
        ...
        // Make an AJAX request to the backend to validate the voucher
        fetch('/claim-voucher', {
            method: 'POST',
            headers: {
        ...
        .catch(error => {
            ...
            alert("There was an error processing the voucher.");
        });
    }
});
